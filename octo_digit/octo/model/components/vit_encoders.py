...
class ViTResnet(nn.Module):
    ...
    # for interopability with palivla
    ...
    def __call__(self, observations: jnp.ndarray, train: bool = True, cond_var=None):
        ...
        if self.normalize_input:
            x = normalize_images(x, self.img_norm_type)
