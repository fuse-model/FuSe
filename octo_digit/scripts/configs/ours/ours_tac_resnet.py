...
def get_config(config_str=None):
    ...
    PRETRAINED_LOADERS = [ModuleSpec.create(resnet_26_loader, exclude_tokenizers=['.*mel_spectro.*',], restore_path='gs://sudeep_r2d2_experiments/R26_S_32-i21k-300ep-lr_0.001-aug_light1-wd_0.1-do_0.0-sd_0.0.npz')] 
