...
from octo.utils.train_utils import resnet_26_loader, tvl_loader, hf_weights_loader
from octo.model.components.tvl_vit import tvlViT
...
def get_config(config_str=None):
    ...
    PRETRAINED_LOADERS = [ModuleSpec.create(tvl_loader, restore_path='gs://oier-europe-bucket/ported_weights/tvl/tvl_vitbgs_params_jax.npz', verbose=True), ModuleSpec.create(hf_weights_loader, hf_model="t5-base",)] 
    DS_NUM = '53.0.0'
