...
def get_config(config_str=None):
    ...
    if REPEAT_TASK_TOKENS: 
        pretrained_path = "gs://oier-v4-bucket/orca_ablations/resntet_t5_b512_20240623_233023"
    else: 
        pretrained_path = 'gs://oier-v4-bucket/orca_ablations/resntet_t5_no_repeat_task_b512_20240624_000915'
    ...
    LANGUAGE_RECONSTRUCTION_HEAD = ModuleSpec.create(
        BCZLanguageHead, # CLIPContrastiveHead,
