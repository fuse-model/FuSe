...
def get_config(config_str=None):
    ...
    FROZEN_KEYS = ["*hf_model.shared*",
                   "*hf_model.encoder.final_layer_norm*",
                   "*hf_model.encoder.block.0.l*",
                   "*hf_model.encoder.block.1.l*",
                   "*hf_model.encoder.block.2.l*",
                   "*hf_model.encoder.block.3.l*",
                   "*hf_model.encoder.block.4.l*",
                   "*hf_model.encoder.block.5.l*",
                   "*hf_model.encoder.block.6.l*",
                   "*hf_model.encoder.block.7.l*",
                   "*hf_model.encoder.block.8.l*",
                   "*hf_model.encoder.block.9.l*", ]
    LANGUAGE_LENGTH = 24
    ...
    PRETRAINED_LOADERS = [ModuleSpec.create(tvl_loader, restore_path='gs://oier-europe-bucket/ported_weights/tvl/tvl_vitbgs_params_jax.npz', verbose=True)] 
    DS_NUM = '53.0.0'
