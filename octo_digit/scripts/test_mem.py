...
def main(_):
    ...
    log_file = os.path.join(parent_directory, 'mem_log.txt')
    success_str = f"batch_size={FLAGS.config.batch_size}, window_size={FLAGS.config['window_size']}\n"
