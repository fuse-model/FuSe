...
CALCULATED_FIELDS = ["spectro", "digit_embeddings"]
...
class MultimodalCommand:
    ...
    def __post_init__(self):
        ...
        self.all_annotations = [
            construct_annotation(key) for key in key_list if key not in REMOVE_KEYS
        ]
        self.index = 0
...
RESPONSE_TO_RESULT = {"s": "success", "f": "failure", "m": "find", "n": "exit"}
